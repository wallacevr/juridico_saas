...
return [
    ...
    'Collection name' => 'Nome da categoria',
    'Collection image' => 'Imagem da categoria',
    'Set this collection active in your store.' => 'Defina esta categoria ativa em sua loja.',
    'e.g. Summer collection, Under $100, Staff picks' => 'e.g. categoria de verão, abaixo de R$ 100, Escolhas da equipe',
    'Add a title and description to see how this collection might appear in a search engine listing.' => 'Adicione um título e uma descrição para ver como essa categoria pode aparecer em uma lista de mecanismo de pesquisa. ',
    'Delete collection?' => 'Excluir categoria?',
    'Are you sure you want to delete this collection? This action cannot be undone.' => 'Tem certeza de que deseja excluir esta categoria? Essa ação não pode ser desfeita.',
    // Marcas
    'Brands' => 'Marcas',
    ...
    // Categorias
    'Categories' => 'Menus',
    'Delete menu?' => 'Deletar menu?',
    'Are you sure you want to delete this menu? This action cannot be undone.' => 'Tem certeza de que deseja excluir esta menu? Essa ação não pode ser desfeita.',
    ...
    'Submenu title' => 'Título da submenu',
    'Submenu url' => 'URL da menu',
