    ...
    @endif
                ...
                <div class="flex items-start">
                    <ul class="nav nav-pills flex flex-col flex-wrap list-none pl-0 mr-4" id="pills-tabVertical" role="tablist">
                        ...
                        <li class="nav-item flex-grow text-center my-2" role="presentation">
                        <a href="#pills-myordersVertical" wire:click="settabv('myorders')" class="
                            nav-link
                            block
                            font-medium
                            text-xs
                            ...
                            py-3
                            focus:outline-none focus:ring-0
                            " id="pills-myorders-tabVertical" data-bs-toggle="pill" data-bs-target="#pills-ordersVertical" role="tab"
                            aria-controls="pills-wishlistVertical" aria-selected="false">{{ __('My orders') }}</a>
                        </li>
                        <li class="nav-item flex-grow text-center my-2" role="presentation">
                    ...
                    @endif
                        ...
                        @if($tabv == 'myorders')
                            <div class="tab-pane fade show active" wire:click="settabv('myorder')" id="pills-myorders-tabVertical" role="tabpanel" aria-labelledby="pills-myorders-tabVertical">
                         @else
                             <div class="tab-pane fade show " wire:click="settabv( 'myorders')"  id="pills-myorders-tabVertical" role="tabpanel" aria-labelledby="pills-myorders-tabVertical">
                          @endif
                      
                                <div class="w-full bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                                        <h1 class="text-center my-4 text-lg font-semibold leading-snug uppercase" >{{__('My orders') }}</h1>
