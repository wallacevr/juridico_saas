...
<div class="grid grid-cols-1 gap-1  md:grid-cols-3 px-6 mx-6 py-4 text-center">
        ...
        <div class="tab-content" id="pills-tabContentVertical" wire:ignore.self>
            @if($tab==4)
                <div class="tab-pane fade show active text-center" id="pills-whatsappVertical" role="tabpanel"
                aria-labelledby="pills-whatsapp-tabVertical">
            @else
                <div class="tab-pane fade text-center" id="pills-whatsappVertical" role="tabpanel"
                aria-labelledby="pills-whatsapp-tabVertical">
            @endif
                <h1 class="bg-gray-500 rounded px-3 text-center">Send the Order do Whatsapp Store</h1>
                <div>
                        <p>
