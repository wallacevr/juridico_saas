<div class="mt-8">
    <h3 class="text-lg font-medium text-gray-900">{{__("applicationSettings.Billing address")}}</h3>
    <div class="mt-2 shadow overflow-hidden sm:rounded-md">
        <div class="px-4 py-5 bg-white sm:p-6 flex flex-row flex-wrap">
            ...
            <div class="w-1/2 p-2">
                <label for="line2" class="block text-sm font-medium leading-5 text-gray-700">{{__("applicationSettings.Line 2")}}
                </label>
                <div class="mt-1 relative rounded-md shadow-sm">
                    <input id="line2" wire:model="line2" type="text" class="form-input block w-full sm:text-sm sm:leading-5" placeholder="{{__("applicationSettings.Center")}}">
                </div>
                @error('line2')
                <p class="text-sm mt-2 text-red-500">
                    {{ $message }}
            ...
            <div class="mt-4 w-1/2 p-2">
                <label for="postal_code" class="block text-sm font-medium leading-5 text-gray-700">{{__("applicationSettings.Postal code")}}
                </label>
                <div class="mt-1 relative rounded-md shadow-sm">
            ...
            <div class="mt-4 w-1/2 p-2">
                <label for="country" class="block text-sm font-medium leading-5 text-gray-700">{{__("applicationSettings.Country")}}
                </label>
                <div class="mt-1 relative rounded-md shadow-sm">
