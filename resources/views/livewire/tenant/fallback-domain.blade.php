<div class="mt-8">
    <h3 class="text-lg font-medium text-gray-900">{{__("applicationSettings.Change fallback subdomain")}}</h3>
    <div class="shadow overflow-hidden sm:rounded-md mt-2">
        <div class="px-4 py-5 bg-white sm:p-6">
            <div>
                <label for="fallback_domain" class="block text-sm font-medium leading-5 text-gray-700">{{__("applicationSettings.Domain")}}
                </label>
