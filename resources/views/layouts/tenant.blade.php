...
<head>
    ...
    <title>{{ config('app.name', 'One Commerce') }}</title>
...
<div id="app">
    ...
    @if(isset($title))
        <div class="relative h-screen flex overflow-hidden bg-gray-100" x-data="{ isOpen: false }">
                            ...
                            <div x-show="showProfile" x-transition:enter="transition ease-out duration-100"
                                ...
                                <div class="py-1" role="none">
                                    ...
                                    <a href="{{ route('tenant.settings.user') }}"
                                       ...
                                       id="options-menu-item-0">{{__('My account')}}</a>
                                </div>
                                <div class="py-1" role="none">
                                    @if(auth()->user()->isOwner())
                                        <a href="{{ route('tenant.settings.application') }}"
                                           class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                                           id="options-menu-item-2">{{__('applicationSettings.Store settings')}}</a>
                                    @endif
                                </div>
                                <div class="py-1" role="none">
                                    ...
                                    <div class="py-1" role="none">
                                        @if(auth()->user()->isOwner())
                                            <a href="{{ route('tenant.settings.application') }}"
                                               ...
                                               tabindex="-1" id="options-menu-item-2">Application settings</a>
                                        @endif
                                    </div>
                                    <div class="py-1" role="none">
