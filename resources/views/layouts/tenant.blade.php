...
<body class="bg-gray-100 h-screen antialiased">
    ...
    -->
      ...
      Leaving: "transition ease-in-out duration-300 transform"
        ...
        To: "-translate-x-full"
    -->
                <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white" aria-hidden="true"
                    x-show="isOpen" x-transition:enter="transition ease-in-out duration-300 transform"
      ...
      -->
          ...
          -->
                            <div x-show="showProfile" x-transition:enter="transition ease-out duration-100"
                                ...
                                <div class="py-1" role="none">
                                    ...
                                    <a href="{{ route('tenant.settings.application') }}"
                                        class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                                        id="options-menu-item-2">Application settings</a>
                                    @endif
                                </div>
                                <div class="py-1" role="none">
                                    <a href="{{ route('tenant.logout') }}" class="text-gray-700 block px-4 py-2 text-sm"
                                        role="menuitem" tabindex="-1" id="options-menu-item-3"
                        ...
                        <nav class="px-3 mt-6">
                            <div class="space-y-1">
                                ...
                                <a href="{{ route('tenant.admin.dashboad') }}"
                                    ...
                                    aria-current="page">
                                    <!--Heroicon name: outline/home Current: "text-gray-500", Default: "text-gray-400 group-hover:text-gray-500"-->
                                    <svg class="text-gray-500 mr-3 flex-shrink-0 h-6 w-6"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div x-data={show:false}>
                                    ...
                                    <div x-show="show">
                                        <div class=" hover:text-gray-900 hover:bg-gray-50">
                                            <a href="{{ route('tenant.brands.index') }}"
                                                class="group flex items-center px-2 py-2 text-sm font-small rounded-md">
                                                <span class="text-gray-700 ml-9">Brands</span>
                                            </a>
                                        </div>
                                        <div class=" hover:text-gray-900 hover:bg-gray-50">
                                            <a href="{{ route('tenant.categories.index') }}"
                                                class="group flex items-center px-2 py-2 text-sm font-small rounded-md">
                                                <span class="text-gray-700 ml-9">Categories</span>
                                            </a>
                                        </div>
                                        <div class="hover:text-gray-900 hover:bg-gray-50" aria-expanded="true">
                                            <a href="{{ route('tenant.collections.index') }}"
                                                class="group flex items-center px-2 py-2 text-sm font-small rounded-md">
                                                <span class="text-gray-700 ml-9">Collections</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="flex flex-col w-0 flex-1 overflow-hidden">
                            ...
                            <div class="ml-3 relative" x-data="{ showProfileTop: false }">
                                <div>
                                    <button @click="showProfileTop = !showProfileTop" type="button"
                                        ...
                                        <img class="w-10 h-10 bg-gray-300 rounded-full flex-shrink-0"
                                            src="{{ auth()->user()->gravatar_url }}" alt="{{ auth()->user()->name }}">
                                    </button>
                                </div>
              ...
              Leaving: "transition ease-in duration-75"
                ...
                To: "transform opacity-0 scale-95"
            -->
                                <div x-show="showProfileTop" x-transition:enter="transition ease-out duration-100"
                                    x-transition:enter-start="transform opacity-0 scale-95"
                                    x-transition:enter-end="transform opacity-100 scale-100"
                                    x-transition:leave="transition ease-in-out duration-300 transform"
                                    x-transition:leave-start="transform opacity-100 scale-100"
