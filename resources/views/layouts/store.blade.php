  ...
  <div id="app" class="w-full">
    <div class="bg-white w-full">
      <header class="relative bg-white">
        <p class="bg-prymary h-10 flex items-center justify-center text-sm font-medium px-4 sm:px-6 lg:px-8">
...
<footer class="bg-prymary " aria-labelledby="footer-heading">
  ...
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
    ...
    <div class="w-full text-center">
      ...
      <p class="text-footer">{{__('Central de Atendimento ').': '.get_config('general/store/phone').' - '.get_config('general/store/company_email')}}</p>
      <p class="text-footer">{{get_config('general/store/address')}}, {{get_config('general/store/number')}} {{get_config('general/store/complement')}} - {{get_config('general/store/neighborhood')}} - {{get_config('general/store/city')}}/{{get_config('general/store/state')}} - {{get_config('general/store/postalcode')}} - {{get_config('general/store/taxvat')}}</p>
    </div>
  </div>
</footer>
