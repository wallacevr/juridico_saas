...
<head>
  ...
  <title>{{ get_config('general/store/name') .' '. !empty($title)?$title:''}}</title>
...
<body class="bg-gray-100 h-screen antialiased w-full">
  ...
  ```
-->
<footer class="bg-prymary " aria-labelledby="footer-heading">
  ...
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
    <div class="pb-8 xl:grid xl:grid-cols-4 xl:gap-8">
      <div class="grid grid-cols-2 gap-8 xl:col-span-4">
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            <h3 class="text-base font-medium text-white">A MARCA</h3>
            <ul role="list" class="mt-4 space-y-4">
              ...
              <li>
                <a href="#" class="text-base text-gray-300 hover:text-white"> Loja </a>
              </li>
          ...
          <div class="mt-12 md:mt-0">
            <h3 class="text-base font-medium text-white">POLÍTICAS</h3>
            <ul role="list" class="mt-4 space-y-4">
              <li>
                <a href="#" class="text-base text-gray-300 hover:text-white"> Política de Entrega </a>
              </li>

              <li>
                <a href="#" class="text-base text-gray-300 hover:text-white"> Troca e Devolução </a>
              </li>

              <li>
                <a href="#" class="text-base text-gray-300 hover:text-white"> Privacidade e Segurança </a>
              </li>
            </ul>
          </div>
        </div>
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            <h3 class="text-base font-medium text-white">MINHA CONTA</h3>
            <ul role="list" class="mt-4 space-y-4">
              <li>
                <a href="#" class="text-base text-gray-300 hover:text-white"> Minha Conta </a>
              </li>

              <li>
                <a href="#" class="text-base text-gray-300 hover:text-white"> Meus Pedidos </a>
              </li>

              <li>
                <a href="#" class="text-base text-gray-300 hover:text-white"> Lista de Desejos </a>
              </li>
            </ul>
          </div>
          <div class="mt-12 md:mt-0">
            <h3 class="text-base font-medium text-white">ATENDIMENTO</h3>
            <ul role="list" class="mt-4 space-y-4">
              <li>
                <a href="#" class="text-base text-gray-300 hover:text-white"> Seg a Sex de 9h às 17h </a>
              </li>

              <li>
                <a href="#" class="text-base text-gray-300 hover:text-white"> Sab de 9h às 12h </a>
              </li>
    ...
    <div class="border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
      <div>
        <h3 class="text-base font-medium text-white">Receba a Newsletter Maxcommerce</h3>
        <p class="mt-2 text-base text-gray-300">receber atualizações sobre novidades, ofertas especiais e promoções.</p>
      </div>
      <form class="mt-4 sm:flex sm:max-w-md lg:mt-0">
        <label for="email-address" class="sr-only">Email address</label>
        <input type="email" name="email-address" id="email-address" autocomplete="email" required class="appearance-none min-w-0 w-full bg-white border border-transparent rounded-md py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white focus:border-white focus:placeholder-gray-400 sm:max-w-xs" placeholder="Seu email">
        <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
          <button type="submit" class="w-full bg-indigo-500 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500">Cadastrar</button>
        </div>
      </form>
    </div>
    <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
      ...
      <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1"><img src="https://cinturafina.maxcommerce.com.br/image/catalog/max-commerce-footer.png" style="filter:inverse">&copy; 2022 Maxcommerce, LTDA. All rights reserved.</p>
    </div>
  </div>
</footer>
