...
@extends('layouts.tenant', ['title' => __('Create brand')])
...
<div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
    ...
    <div class="space-y-6 sm:px-6 lg:px-0 lg:col-span-8">
        <form id="brandForm" action="{{ route('tenant.brands.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                    <div class="grid grid-cols-3 gap-6">
                        <div class="col-span-12 sm:col-span-3">
                            @include('layouts.snippets.fields', ['type'=>'text','label'=>'Name','placeholder'=>'Brand name','name'=>'name','value'=> '' ])
                        </div>
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                    ...
                    <div class="col-span-12 sm:col-span-3">
                        @include('layouts.snippets.fields', ['type'=>'text','label'=>'Title','placeholder'=>'Page title','name'=>'page_title','value'=> '' ])
                    </div>
                    ...
                    <div class="col-span-3 sm:col-span-2">
                        ...
                        <div class="mt-1 rounded-md shadow-sm flex">
                            <span class="bg-gray-50 border border-r-0 border-gray-300 px-3 inline-flex items-center text-gray-500 sm:text-sm">
                                {{ Request::getHost() . '/' . __('brands') . '/'}}
                            </span>
                            <input type="text" name="slug" id="slug" autocomplete="slug" class="mt-1 block w-full border border-gray-300 shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{ old('slug') }}" />
                        </div>
                        @error('slug')
