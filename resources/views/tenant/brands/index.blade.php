@extends('layouts.tenant', ['title' => __('label.Brands')]) @section('content')
									...
									<tr>
										...
										<td class="px-6 py-4 whitespace-nowrap">
											<div class="flex items-center">
												...
												<form
													action="{{ route('tenant.brands.destroy', ['brand' => $brand->id]) }}"
			...
			<div class="sm:flex sm:items-start">
				...
				<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
					<h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
						{{ __('label.Delete brand?') }}
					</h3>
					<div class="mt-2">
						<p class="text-sm text-gray-500">
							{{ __('label.Are you sure you want to delete this brand? This action cannot be undone.') }}
						</p>
					</div>
				</div>
			</div>
