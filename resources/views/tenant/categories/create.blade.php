...
@extends('layouts.tenant', ['title' => __('Create category')]) @section('content')

@include('tenant.categories.modal')
...
<div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
    ...
    <div class="shadow sm:rounded-md sm:overflow-hidden">
        <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
            ...
            <hr>
            <ol class='menu-items'></ol>
        </div>
        <button type="button" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 w-full open-modal">
            Add menu item
        </button>
    </div>
</div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            ...
                            <p class="text-gray-500">
                                Set this menu active in your store.
                            </p>
                        </div>
                    </div>
                </div>
...
<script src="{{ URL::to('/') . '/js/add-menu-modal.js' }}"></script>
