...
<div class="">
	<div class="max-w-7xl mx-auto">
		<a href="http://fernando.saas.test:8000/admin/brands/create" class="px-5 py-2 text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 active:bg-indigo-700 transition ease-in-out duration-150">
			Novo cliente
		</a>
								...
								<tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($customers as $customer)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap"> {{$customer->created_at}}  </td>
                                            <td class="px-6 py-4 whitespace-nowrap"> 
                                                ...
                                                <form
													action="{{ route('tenant.customers.destroy', ['customer_id' => $customer->id]) }}"
				...
				<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
					...
					<div class="mt-2">
						<p class="text-sm text-gray-500">
							Are you sure you want to delete this client? All of your data will be permanently
