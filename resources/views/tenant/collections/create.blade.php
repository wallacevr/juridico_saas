                    ...
                    <div class="grid grid-cols-3 gap-6">
                        <div class="col-span-12 sm:col-span-3">
                            ...
                            <input type="text" name="collection-name" id="collection-name"
                                autocomplete="collection-name" class="
                                    mt-1
                                    block
                                    w-full
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                    ...
                    <div class="col-span-12 sm:col-span-3">
                        ...
                        <input type="text" name="page-title" id="page-title" autocomplete="page-title" class="
                                    mt-1
                                    block
                                    w-full
                                    border border-gray-300
                    ...
                    <div class="col-span-3">
                        ...
                        <div class="mt-1">
                            <textarea id="seo-description" name="seo-description" rows="5" class="
                                        shadow-sm
                                        focus:ring-indigo-500
                                        focus:border-indigo-500
                                        mt-1
                    ...
                    <div class="col-span-3 sm:col-span-2">
                        ...
                        <div class="mt-1 rounded-md shadow-sm flex">
                            ...
                            <input type="text" name="slug" id="slug" autocomplete="slug" class="
                                    mt-1
                                    block
                                    w-full
                                    border border-gray-300
                ...
                <div class="mt-4 space-y-4">
                    <div class="flex items-start">
                        <div class="h-5 flex items-center">
                            <input id="status" name="status" type="checkbox" class="
                                            focus:ring-indigo-500
                                            h-4
                                            w-4
                                            text-indigo-600
            ...
            <div class="
                ...
                <div class="space-y-1 text-center">
                    ...
                    <div class="flex text-sm text-gray-600">
                        <label for="collection-image" class="
                                                relative
                                                cursor-pointer
                                                bg-white
                                                rounded-md
                            ...
                            <input id="collection-image" name="collection-image" type="file" class="sr-only" />
                        </label>
