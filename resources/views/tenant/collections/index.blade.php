@extends('layouts.tenant', ['title' => __('label.Collections')]) @section('content')

<div class="">
	<div class="max-w-7xl mx-auto">
		<a href="{{ route('tenant.collections.create') }}"
								...
								<tbody class="bg-white divide-y divide-gray-200">
									...
									<tr>
										...
										<td class="px-6 py-4 whitespace-nowrap">
											<div class="flex items-center">
												<a
													href="{{ route('tenant.collections.edit', ['collection' => $collection->id]) }}">
												...
												<form
													action="{{ route('tenant.collections.destroy', ['collection' => $collection->id]) }}"
			...
			<div class="sm:flex sm:items-start">
				...
				<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
					<h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
						{{ __('label.Delete collection?') }}
					</h3>
					<div class="mt-2">
						<p class="text-sm text-gray-500">
							{{ __('label.Are you sure you want to delete this collection? This action cannot be undone.') }}
						</p>
					</div>
				</div>
			</div>
