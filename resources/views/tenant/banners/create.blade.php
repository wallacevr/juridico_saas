...
<div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
    ...
    <div class="space-y-6 sm:px-6 lg:px-0 lg:col-span-8">
        <form action="{{ route('tenant.banners.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                    <div class="grid grid-cols-3 gap-6">
                        ...
                        <div class="col-span-12 sm:col-span-3">
                            ...
                            <input type="text" name="url" autocomplete="url" value="{{ old('url') }}"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                            @error('url')
                            <p class="mt-2 text-sm text-red-500">
                                {{ $message }}
                        ...
                        <div class="col-span-3">
                            ...
                            <div class="mt-1">
                                <textarea name="title" rows="2"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ old('title') }}</textarea>
                                @error('title')
                                <p class="mt-2 text-sm text-red-500">
                                    {{ $message }}
                                </p>
