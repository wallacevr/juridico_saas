  ...
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
		...
		<div class="row">
			<div class="col-6">
					...
					<input type="text" class="form-control" name="nome" placeholder="Nome/RazãoSocial"></input>
			</div>
		</div>
		<div class="row">
			<div class="col-6 pj">
					<label for="nomefantasia" class="form-label"></label>
					<input type="text" class="form-control pj" name="nomefantasia" placeholder="Nome Fantasia"></input>
			</div>
		</div>
		<div class="row">
			<div class="col-3">
					<label for="telefone" class="form-label"></label>
					<input type="text" class="form-control" name="telefone" placeholder="Telefone"  onkeypress="mask(this, mphone);" onblur="mask(this, mphone);"></input>
			</div>
			<div class="col-3">
		...
		<div class="row">
			...
			<div class="col-6">
					...
					<input type="url" class="form-control" name="site" placeholder="Site"></input>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-2">
					...
					<input type="text" class="form-control" name="cep" id="cep" placeholder="CEP"></input>
			</div>
			
			<div class="col-1">
					<label for="uf" class="form-label"></label>
					<input type="text" class="form-control" name="uf" id="uf" placeholder="UF"></input>
			</div>
			<div class="col-3">
		...
		<div class="row">
				<div class="col-3">
						...
						<input type="text" class="form-control" name="bairro" id="bairro" placeholder="Bairro"></input>
				</div>
				<div class="col-3">
		...
		<div class="row">
				...
				<div class="col-3">
						...
						<input type="text" class="form-control" name="numero" id="numero" placeholder="Nº"></input>
				</div>
				<div class="col-3">
  ...
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
  		<div class="row">
			<div class="col-3 pj">
					...
					<input type="text" class="form-control pj" name="cnpj" id="cnpj" placeholder="CNPJ"></input>
			</div>
			<div class="col-3 pf">
					<label for="cpf" class="form-label"></label>
					<input type="text" class="form-control pf" name="cpf"id="cpf" placeholder="CPF"></input>
			</div>
		</div>
		<div class="row pj">
			<div class="col-3">
					<label for="ie" class="form-label"></label>
					<input type="text" class="form-control pj" name="ie" id="ie" placeholder="Inscrição Estadual"></input>
			</div>
			<div class="col-3">
					<label for="ccm" class="form-label"></label>
					<input type="text" class="form-control pj" name="ccm" id="ccm" placeholder="Inscrição Municipal"></input>
			</div>
		</div>
		...
		<div class="row pf">
			<div class="col-3 pf">
					...
					<input type="text" class="form-control pf" name="rg" id="rg" placeholder="RG"></input>
			</div>
			<div class="col-3 pf">
					<label for="ctps" class="form-label pf"></label>
					<input type="text" class="form-control pf" name="ctps" id="ctps" placeholder="CTPS"></input>
			</div>
		</div>
		<div class="row pf">
			<div class="col-3 pf">
					<label for="pis" class="form-label pf"></label>
					<input type="text" class="form-control pf" name="pis" id="pis" placeholder="PIS"></input>
			</div>
			<div class="col-3 pf">
					<label for="cnh" class="form-label pf"></label>
					<input type="text" class="form-control pf" name="cnh" id="cnh" placeholder="CNH"></input>
			</div>
		</div>
		<div class="row pf">
			<div class="col-3 pf">
					<label for="titulo" class="form-label"></label>
					<input type="text" class="form-control" name="titulo" id="titulo" placeholder="Titulo de Eleitor"></input>
			</div>
			<div class="col-3 pf">
					<label for="passaporte" class="form-label"></label>
					<input type="text" class="form-control" name="passaporte" id="passaporte" placeholder="Passaporte"></input>
			</div>
		</div>
		<div class="row">
			<div class="col-3 pf">
					<label for="reservista" class="form-label"></label>
					<input type="text" class="form-control" name="reservista" id="reservista" placeholder="Certificado de Reservista"></input>
			</div>
  ...
  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
  		<div class="row pf">
			<div class="col-3">
					...
					<input type="text" class="form-control" name="nomemae" id="nomemae" placeholder="Nome da Mãe"></input>
			</div>
			<div class="col-3">
					<label for="nomepai" class="form-label"></label>
					<input type="text" class="form-control" name="nomepai" id="nomepai" placeholder="Nome do Pai"></input>
			</div>
		</div>
		<div class="row pf">
			<div class="col-3">
					<label for="naturalidade" class="form-label"></label>
					<input type="text" class="form-control" name="naturalidade" id="naturalidade" placeholder="Naturalidade"></input>
			</div>
			<div class="col-3">
					<label for="nacionalidade" class="form-label"></label>
					<input type="text" class="form-control" name="nacionalidade" id="nacionalidade" placeholder="Nacionalidade"></input>
			</div>
		</div>
		<div class="row mt-2 pf">
			...
			<div class="col-2">
					...
					<input type="date" class="form-control" name="dtnasc" id="dtnasc" placeholder="Data de Nascimento"></input>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-3 ">
					...
					<input type="text" class="form-control" name="banco" id="banco" placeholder="Banco"></input>
			</div>
		...
		<div class="row">
			<div class="col-3">
					...
					<input type="text" class="form-control" name="conta" id="conta" placeholder="Conta e Dígito"></input>
			</div>
			<div class="col-3">
					<label for="agencia" class="form-label"></label>
					<input type="text" class="form-control" name="agencia" id="agencia" placeholder="Agencia e Digito"></input>
			</div>
		</div>
  </div>
</div>
