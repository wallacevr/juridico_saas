...
<div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
    ...
    <div class="space-y-6 sm:px-6 lg:px-0 lg:col-span-8">
        <form action="{{ route('tenant.pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                    <div class="grid grid-cols-3 gap-6">
                        <div class="col-span-12 sm:col-span-3">
                            ...
                            <input type="text" name="name" value="{{ old('name')  ? old('name') :  $page->name}}"
                        ...
                        <div class="col-span-3">
                            ...
                            <div class="mt-1">
                                <textarea name="content" rows="5"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ">{{ old('content') ? old('content') :  $page->content}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                    ...
                    <div class="col-span-12 sm:col-span-3">
                        ...
                        <input type="text" name="title" value="{{ old('title')  ? old('title') :  $page->title}}"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                    </div>
                    ...
                    <div class="col-span-12 sm:col-span-3">
                        ...
                        <input type="text" name="link" value="{{ old('link')  ? old('link') :  $page->link}}"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                    </div>
                    ...
                    <div class="col-span-3">
                        ...
                        <div class="mt-1">
                            <textarea name="description" rows="5"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ old('description') ? old('description') :  $page->description}}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="flex items-start">
                            <div class="h-5 flex items-center">
                                <input id="status" name="status" type="checkbox"
                                    ...
                                    {{ old('status') || $page->status ? 'checked' : '' }} value="1" />
                            </div>
